...
@EqualsAndHashCode
public class BodyDataProductDownloadDTO implements Serializable {
    @NonNull
    private final MetaDTO meta;
    @NonNull
    private final BodyDataProductDownloadDTO.Request request;
    @NonNull
    private final BodyDataProductDownloadDTO.Response response;
