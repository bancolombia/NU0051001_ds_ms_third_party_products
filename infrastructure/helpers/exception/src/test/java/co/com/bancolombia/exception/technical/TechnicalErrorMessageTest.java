...
class TechnicalErrorMessageTest {
    ...
    void shouldValidateBusinessErrorMessageSuccessfully(String enumName, String code, String message) {
        TechnicalErrorMessage technicalErrorMessage = TechnicalErrorMessage.valueOf(enumName);
        assertEquals(code, technicalErrorMessage.getCode());
        assertEquals(message, technicalErrorMessage.getMessage());
    }
}