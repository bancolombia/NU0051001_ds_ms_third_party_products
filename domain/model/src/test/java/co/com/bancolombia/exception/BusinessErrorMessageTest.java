...
class BusinessErrorMessageTest {
    ...
    @CsvSource({
            ...
            "CUSTOMER_IDENTIFICATION_TYPE_IS_REQUIRED, MPB0037, The customer-identification-type field cannot be null or empty",
            "CUSTOMER_IDENTIFICATION_NUMBER_IS_REQUIRED, MPB0038, The customer-identification-number field cannot be null or empty",
            ...
            "BENEFICIARY_DIFFERENT_THAN_CUSTOMER, MPB0042, The beneficiary can't have the same identification that the customer",
